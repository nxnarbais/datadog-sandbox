...
variable "threshold_per_cluster" {
  description = "Maximum indexed span volume for a cluster"
  default = 10000000
}

variable "threshold_per_service" {
  description = "Maximum indexed span volume for a service"
  default = 1000000
}

variable "minimum_service_volume" {
  description = "Minimum indexed span volume to trigger an anomaly"
  default = 300000
}
